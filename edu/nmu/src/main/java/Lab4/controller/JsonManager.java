...
public class JsonManager {
    ...
    public void writeUnivToFile(UnivStructureUnit univ, String fileName) {
        try {
            File jsonFile = new File(String.format("edu/nmu/src/main/java/Lab4/data/%s.json", fileName));
    ...
    public University readUnivFromFile(String fileName){
        try {
            FileReader fileReader = new FileReader(String.format("edu/nmu/src/main/java/Lab4/data/%s.json", fileName));
