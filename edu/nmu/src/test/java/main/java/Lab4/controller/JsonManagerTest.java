...
class JsonManagerTest {
    ...
    public void init(){
        ...
        jsonFile = new File("edu/nmu/src/main/java/Lab4/data/UnitTestJson.json");
        try {
    ...
    void readUnivFromFile() {
        try {
            FileReader fileReader = new FileReader("edu/nmu/src/main/java/Lab4/data/UnitTestJson.json");
